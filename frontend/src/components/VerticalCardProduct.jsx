  ...
  return (
    <div className='container mx-auto py-4 px-4 my-6 '>
...

        {
         ...
         <div className='w-full   min-w-[280px] md:min-w-[370px] max-w-[280px] md:max-w-[370px]  bg-white rounded-sm shadow animate-pulse ' key={index}>
           <div className='bg-slate-200 h-48 p-4 min-w-[120px] md:min-w-[145px] flex justify-center items-center'  >
            <img src={' '}  className='h-full object-scale-down hover:scale-110 transition-all bg-blend-multiply' alt="" />
         ...
         <div className='w-full   min-w-[280px] md:min-w-[370px] max-w-[280px] md:max-w-[370px]  bg-white rounded-sm shadow ' key={index}>
           <div className='bg-slate-200 h-48 p-4 min-w-[120px] md:min-w-[145px] flex justify-center items-center'   >
