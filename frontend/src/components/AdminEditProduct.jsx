...
function AdminEditProduct({onClose,productData,fetchdata}) {
    ...
    const handleSubmit = async (e) =>{
      ...
      const uploadresponse = await fetch(SummaryApi.updateProduct.url,{
  ...
  return (
     <div className='fixed z-10 h-full w-full top-0 bottom-0 right-0 left-0 bg-slate-200 bg-opacity-50  flex justify-center items-center'>
